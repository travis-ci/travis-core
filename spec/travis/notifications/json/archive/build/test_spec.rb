...
describe Travis::Notifications::Json::Archive::Build::Test do
  ...
  let(:data)  { Travis::Notifications::Json::Archive::Build::Test.new(build).data }

  it 'build' do
    data['build'].except('matrix', 'repository').should == {
      'id' => build.id,
      'number' => 2,
