...
CREATE INDEX index_builds_on_repository_id_and_event_type_and_state_and_bran ON builds USING btree (repository_id, event_type, state, branches);
...
CREATE INDEX index_commits_on_branch ON commits USING btree (branches);
...
--
-- Name: index_workers_on_full_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_workers_on_full_name ON workers USING btree (full_name);


--
-- Name: index_workers_on_last_seen_at; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_workers_on_last_seen_at ON workers USING btree (last_seen_at);
...
INSERT INTO schema_migrations (version) VALUES ('20130614131351');
...
INSERT INTO schema_migrations (version) VALUES ('20130906082610');
